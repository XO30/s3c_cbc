...
class LaserScanProcessor:
    ...
    def scan_callback(self, scan):
        ...
        for i, desired_angle in enumerate(self.desired_angles):
            ...
            if closest_angle is not None:
                ...
                if -math.pi < closest_angle < 0 and distance < closest_distance:
    ...
    def stop(self):
        ...
        try:
            ...
            self.aica.switch_controllers("robot", deactivate=["impedance"])
        except Exception:
            pass
        self.stopped = True
        self.full_speed = False
    ...
    def modulate_speed(self, factor):
        ...
        try:
            if self.stopped:
                self.aica.switch_controllers("robot", activate=["impedance"])
                self.stopped = False
